...
def ler_HUFFMAN(nome_ficheiros, tempo):
    print("Huffman")
    for i in range(len(nome_ficheiros)):
        print(nome_ficheiros[i])
        inicio_tempo = time()

        h = HuffmanCoding(nome_ficheiros[i])
        novo_nome = h.compress()
...
class HuffmanCoding:
    ...
    def compress(self):
        ...
        output_path = "Huffamn_" + filename + ".bin"
    ...
    def decompress(self, input_path):
        ...
        if input_path.endswith(".txt"):
            output_path = "Huffman_descompressed" +filename + ".txt"
        
        elif input_path.endswith(".csv"):
            output_path = "Huffman_descompressed" +filename + ".csv"
        
        elif input_path.endswith(".js"):
            output_path = "Huffman_descompressed" +filename + ".js" 
